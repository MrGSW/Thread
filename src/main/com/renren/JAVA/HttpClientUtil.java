...
/**
 * Created by shengwen.gan on 2018/11/5. desc:
 */
  ...
  public static CloseableHttpClient createHttpClient(int maxTotal,
    ...
    HttpRequestRetryHandler httpRequestRetryHandler = new HttpRequestRetryHandler() {
      public boolean retryRequest(IOException exception,
          int executionCount, org.apache.http
          .protocol.HttpContext context) {
...
//      String result = EntityUtils.toString(entity, "utf-8");
//      String result = String.valueOf(entity.getContentLength());
      double result = Double.valueOf(entity.getContentLength()) /
          (1024.0 * 1024.0);
  ...
  public static void main(String[] args) {
    // URL列表数组
    String[] urisToGet = {
        "https://cdn.chime.me/image/fs01/sitebuild/20180902/20/original_20924173588546236.jpeg",
        "https://cdn.chime.me/image/fs01/sitebuild/20180902/20/original_20924173327916307.jpeg",
       };
